...
public class DeveloperFactory {
    public static Developer createDeveloper(Developer developer, Taxable taxable){
        ...
        } else if (developer.getExperience().equals(Experience.MID)) { // Parantez hatası düzeltildi
        ...
        } else if (developer.getExperience().equals(Experience.SENIOR)) { // Parantez hatası düzeltildi
